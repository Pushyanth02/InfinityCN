...
export const PreferencesSection: React.FC<PreferencesSectionProps> = ({ preferences, onChange }) => {
  return (
    <section className="settings-section preferences-section" aria-labelledby="preferences-heading">
      <h2 id="preferences-heading" className="settings-section-title">Reader Preferences</h2>
