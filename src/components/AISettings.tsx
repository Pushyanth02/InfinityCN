...
const FEATURES = [
    {
        ...
        label: 'Rich Character Codex',
        desc: 'Personality, role & narrative arc per character',
    },
    {
        icon: <FileText size={16} />,
        label: 'Cinematic Story Recap',
        desc: 'Atmospheric 2-3 paragraph chapter summary',
    },
    {
        icon: <Theater size={16} />,
        label: 'Genre & Style Analysis',
        desc: 'Genre, voice, pacing style & iconic quote',
    },
    {
        icon: <Lightbulb size={16} />,
        label: 'Key Insights',
        desc: 'Thematic motifs, tone shifts & narrative techniques',
    },
    {
        icon: <CloudFog size={16} />,
        label: 'Mood Enhancement',
        desc: 'Vivid atmospheric prose atmosphere description',
    },
];
    ...
    const handleTest = async () => {
        ...
        try {
            ...
            setTest({
                ...
                provider: aiProvider,
                message:
                    err instanceof Error ? err.message : 'Connection test failed unexpectedly.',
            });
        } finally {
            setTesting(false);
        }
                    ...
                    >
                        ...
                        <div className="ai-modal-header">
                            <div className="ai-modal-title-row">
                                ...
                                <div>
                                    <h2 id="ai-title" className="ai-modal-title font-display">
                                        AI Intelligence
                                    </h2>
                                    <p className="ai-modal-subtitle">
                                        Provider:{' '}
                                        <span
                                            className="active-provider-label"
                                            style={
                                                {
                                                    '--provider-color': activeProvider.color,
                                ...
                                >
                                        ...
                                        {PROVIDERS.map(p => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="ai-provider-card-label">
                                                        {p.label}
                                                    </div>
                                                    <div className="ai-provider-card-desc">
                                                        {p.desc}
                                                    </div>
                                                    {active && (
                                                        <div className="ai-provider-card-dot" />
                                                    )}
                                                </button>
                                            );
                                        })}
                                        ...
                                        >
                                            <div className="ai-input-group">
                                                ...
                                                <input
                                                    ...
                                                    value={geminiKey}
                                                    onChange={e =>
                                                        setAiConfig({ geminiKey: e.target.value })
                                                    }
                                                />
                                    ...
                                    {aiProvider === 'openai' && (
                                        <motion.div
                                            ...
                                            animate={{ opacity: 1, height: 'auto' }}
                                        >
                                            <label className="ai-input-label" htmlFor="openai-key">
                                                OpenAI API Key
                                            </label>
                                            <input
                                                id="openai-key"
                                                ...
                                                value={openAiKey}
                                                onChange={e =>
                                                    setAiConfig({ openAiKey: e.target.value })
                                                }
                                            />
                                            <p className="ai-input-hint">
                                                Stored securely in browser. Get one at{' '}
                                                <a
                                    ...
                                    {aiProvider === 'anthropic' && (
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                value={anthropicKey}
                                                onChange={e =>
                                                    setAiConfig({ anthropicKey: e.target.value })
                                                }
                                            />
                                            <p className="ai-input-hint">
                                                Get one at{' '}
                                    ...
                                    {aiProvider === 'groq' && (
                                        <motion.div
                                            ...
                                            animate={{ opacity: 1, height: 'auto' }}
                                        >
                                            <label className="ai-input-label" htmlFor="groq-key">
                                                Groq API Key
                                            </label>
                                            <input
                                                id="groq-key"
                                                ...
                                                value={groqKey}
                                                onChange={e =>
                                                    setAiConfig({ groqKey: e.target.value })
                                                }
                                            />
                                            <p className="ai-input-hint">
                                                Get one at{' '}
                                    ...
                                    {aiProvider === 'deepseek' && (
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                value={deepseekKey}
                                                onChange={e =>
                                                    setAiConfig({ deepseekKey: e.target.value })
                                                }
                                            />
                                            <p className="ai-input-hint">
                                                Get one at{' '}
                                        ...
                                        >
                                            <div className="ai-input-group">
                                                ...
                                                <input
                                                    ...
                                                    value={ollamaUrl}
                                                    onChange={e =>
                                                        setAiConfig({ ollamaUrl: e.target.value })
                                                    }
                                                />
                                            </div>
                                            <div className="ai-input-group">
                                        ...
                                        aiProvider !== 'ollama' && (
                                            <div className="ai-test-section ai-grounding-section">
                                                <div className="ai-input-group ai-grounding-row">
                                                    ...
                                                    />
                                                    <label
                                                        className="ai-input-label ai-grounding-label"
                                                        htmlFor="global-grounding"
                                                    >
                                                        <Search
                                                            size={14}
                                                            className="ai-grounding-icon"
                                                        />{' '}
                                                        Ground with Web Search
                                                    </label>
                                                    <p className="ai-input-hint ai-grounding-hint">
                                                        If supported by the API/model, this injects
                                                        live web search data to improve context.
                                                    </p>
                                                </div>
                                            </div>
                                        )}
                                                ...
                                                {testStatus && (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="ai-test-result-body">
                                                            <div className="ai-test-result-msg">
                                                                {testStatus.message}
                                                            </div>
                                                            {testStatus.latencyMs != null && (
                                                                <div className="ai-test-result-latency">
                            ...
                            {tab === 'features' && (
                                ...
                                >
                                    <p className="ai-features-intro">
                                        All features fall back to offline algorithms automatically
                                        when AI is disabled.
                                    </p>
                                    <ul className="ai-features-list">
                                        {FEATURES.map(f => (
                                            <li key={f.label} className="ai-feature-item">
                                                ...
                                                <span
                                                    className={`ai-feature-status ${aiProvider !== 'none' ? 'ai-feature-status--on' : 'ai-feature-status--off'}`}
                                                >
