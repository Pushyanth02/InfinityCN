...
export const SECURITY_HEADERS: Record<string, string> = {
  ...
  // Content-Security-Policy: restrict all resource loading to self (with
  // 'unsafe-inline' for styles since Tailwind + shadcn use inline styles,
  // and data: for images). No external scripts, no external connections.
